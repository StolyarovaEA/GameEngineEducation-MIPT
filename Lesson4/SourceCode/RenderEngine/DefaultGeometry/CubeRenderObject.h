...
class RENDERENGINE_API CubeRenderObject1 final : public RenderObject
{
public:
	CubeRenderObject1(RenderProxy* pRenderProxy);

	virtual void* GetVertices() const override { return (void*)s_cube1Vertices; }
	virtual UINT32 GetVerticesSize() const override { return sizeof(s_cube1Vertices); }
	virtual void* GetIndices() const override { return (void*)s_cube1TriList; }
	virtual UINT32 GetIndicesSize() const override { return sizeof(s_cube1TriList); }
	virtual std::string GetVsShaderName() const override { return "vs_cubes"; }
	virtual std::string GetPsShaderName() const override { return "fs_cubes"; }

private:
	inline static const PosColorVertex s_cube1Vertices[] =
	{
		{-.5f,  .5f,  .5f, 0xff000000 },
		{ .5f,  .5f,  .5f, 0xff0000ff },
		{-.5f, -.5f,  .5f, 0xff00ff00 },
	...
	inline static const uint16_t s_cube1TriList[] =
	{
		0, 1, 2, // 0
		1, 3, 2,
		4, 6, 5, // 2
